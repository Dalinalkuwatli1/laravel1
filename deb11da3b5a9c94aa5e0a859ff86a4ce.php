<?php $__env->startSection('content'); ?>
    ...
    <div class="swiper-mt">
        <div class="swiper-wrapper">
            <div class="swiper-slide slider-img" style="background-image: url('<?php echo e(asset('site/images/1.jpg')); ?>');">
                <div class="container slider-caption">

                </div>
            </div>
            <!-- /slider-img -->
            <div class="swiper-slide slider-img" style="background-image: url('<?php echo e(asset('site/images/30.jpg')); ?>');">
                <div class="container slider-caption">

                </div>
            </div>
            <!-- /slider-img -->
            <div class="swiper-slide slider-img" style="background-image: url('<?php echo e(asset('site/images/2.jpg')); ?>');">
                <div class="container slider-caption">
    ...
    <div id="wrap-content" class="page-content custom-page-template">
                ...
                <div class="row">
                    <div class="col-lg-6 order-mobi2">
                        <div class="margin-r50">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="img-fluid radius10 margin-b30" src='<?php echo e(asset('site/images/4.jpg')); ?>'
                                        alt=" " />
                                    <img class="img-fluid radius10" src='<?php echo e(asset('site/images/1.jpg')); ?>' alt=" " />
                                </div>
                                <!-- /col-md-6 -->
                                <div class="col-md-6">

                                    <img class="img-fluid radius10  margin-t30" src='<?php echo e(asset('site/images/444.jpg')); ?>'
                                        alt=" " />
                                </div>
                                <!-- /col-md-6 -->
                            </div>
        ...
        <div id="home-section-2-2" class="section-holder home-section-2-2">
            <div class="container">
                ...
                <div class="row">
                    <?php $__currentLoopData = $Products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $showworklist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="item-portfolio-holder-v2" style="width: 100%; height: 350px; cursor: pointer;"
                                onclick="openDressModal(
    '<?php echo e(asset($showworklist->image)); ?>',
    '<?php echo e($showworklist->title); ?>',
    '<?php echo e($showworklist->description); ?>',
    '<?php echo e($showworklist->id); ?>',
    '<?php echo e($showworklist->price); ?>'
)">

                                <div class="post-image item-grid-image-v2">
                                    <img loading="lazy" src="<?php echo e(asset($showworklist->image)); ?>"
                                        class="img-grid-v2 w-100 h-100 object-fit-cover rounded"
                                        alt="<?php echo e($showworklist->title); ?>">
                                </div>
...
function updateSidebar(image, title, price, color, size) {
    ...
    const sidebarContent = `
        ...
        <a href="<?php echo e(route('cart.index')); ?>" class="btn w-100" style="background-color: #AA896F; color: white; text-align: center; display: inline-block; text-decoration: none;">Go to Cart</a>
    ...
    sidebar.innerHTML = sidebarContent;
     ...
     style="background-image:url('<?php echo e(asset('site/images/1.jpg')); ?>');">
                            ...
                            <div class="col-lg-6">
                                <div class="margin-l50">
                                    <div id="contact-form-holder">
                                        <form method="POST" action='<?php echo e(route('contuctus.store')); ?>'>
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
    ...
    <div class="bg-success text-white"><?php echo e(session('success')); ?></div>
<?php endif; ?>
...
<?php echo $__env->make('site.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dalin\Desktop\DalinLaravel\resources\views/site/layouts/home.blade.php ENDPATH**/ ?>