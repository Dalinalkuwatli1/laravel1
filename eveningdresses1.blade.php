...
@section('content')
		...
		<div class="top-single-bkg top-single-gallery">
			<div class="topsingleimg"> <img src="{{ asset('site/images/55.jpg') }}"alt="" width="1900" height="1000"></div>
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">evening dresses</h1>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;"onclick="openGalleryModal('{{ asset('site/images/51.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/51.jpg') }}"alt="Elegant Evening Dress" style="width: 100%; height: auto;">
        </div>
        ...
        <div class="mt-2 text-center">
          <h5 class="mb-1">Elegant Evening Dress</h5>
	    ...
	    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/44.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/44.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height: auto;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
	    ...
	    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/46.jpg') }}', 'Elegant Evening Dress', '$2200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/46.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height: auto;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
...
<div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/76.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/76.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height: auto;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
        ...
        <div class="mt-2 text-center">
         ...
         <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/97.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/97.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height:100%;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
	    ...
	    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/51.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/45.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height:100%;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
	    ...
	    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/88.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/88.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height: auto;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4 position-relative item-portfolio">
        <div style="cursor: pointer;" onclick="openGalleryModal('{{ asset('site/images/42.jpg') }}', 'Elegant Evening Dress', '$1200')">
          <img class="img-fluid" loading="lazy" src="{{ asset('site/images/42.jpg') }}" alt="Elegant Evening Dress" style="width: 100%; height: auto;">
        </div>
        <div class="position-absolute top-0 end-0 m-2 heart-icon-container">
          <div class="heart-circle" onclick="event.stopPropagation(); toggleHeart(this)">
            <i class="fa-regular fa-heart fs-4"></i>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content p-4">
      ...
      <div class="modal-body row">
        <div class="col-md-6">
          <img id="galleryImage" src="" class="img-fluid rounded" alt="Dress Image">
        </div>
        <div class="col-md-6">
...
<div id="footer-instagram">
 ...
 function openGalleryModal(imageSrc, title, price) {
    ...
    // إعادة تعيين التقييم والقياس إذا أردت
    resetRating();
    resetSizeButtons();
    // عرض المودال (باستخدام Bootstrap 5)
  ...
  function selectSize(button) {
    ...
    // يمكن حفظ المقاس المختار في متغير إذا أردت استخدامه لاحقاً
  }

  function resetSizeButtons() {
    document.querySelectorAll('#galleryModal .btn-outline-secondary, #galleryModal .btn-primary').forEach(btn => {
  ...
  function resetRating() {
    document.querySelectorAll('#galleryRating .star').forEach(star => star.textContent = '☆');
  }
  ...
  function confirmGalleryCart() {
    ...
    confirmation.textContent = 'The dress has been successfully added to the cart!';
