<div id="footer-instagram">
    <ul class="social-media">
        <li><a class="social-facebook" href="{{ $Settings->feb }}" target="_blank"><i class="fab fa-facebook-f"></i> </a></li>
...
<footer>
    <div class="container">
                    ...
                    <div class="foo-block">
                        <div class="widget_text widget widget-footer">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><i class="fas fa-mobile-alt"></i><span> {{ $Settings->phone }}</span></li>
                                <li><i class="far fa-envelope"></i><span> {{ $Settings->email }}</span></li>
                            </ul>
                        </div>
                    </div></div>
                <!-- /col-lg-3 -->
                <div class="col-lg-3 col-sm-6">
                    <div class="foo-block">
                        <div class="widget_text widget widget-footer">
                            ...
                            <ul>
                                <li><a href="{{ route('sitehome.index') }}">Home</a></li>
        ...
        <div class="copyright"><h6>
            <div class="footer-copy"> <span class="footer-year">2025</span> &copy; glamour. Designed by eng.dalin alkuwatli.</div></h6>
    </div>
</footer>
<!-- /FOOTER -->
<div class="scrollup">
