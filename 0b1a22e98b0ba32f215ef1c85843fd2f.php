...
?>
 ...
 <img class="img-fluid" src="<?php echo e(asset('site/images/110 (2).png')); ?>" alt="Glamour" width="139"
 height="90">
 </div>
...
<a href="#" class="icon-link" onclick="openSidebar()">
  ...
  <span class="cart-count-badge <?php echo e($orderCount == 0 ? 'zero' : ''); ?>">
    <?php echo e($orderCount > 0 ? $orderCount : 0); ?>
...
<a href="<?php echo e(route('llogin')); ?>" class="icon-link">
 ...
 <a href="<?php echo e(route('sitehome.index')); ?>">Home</a>
...
<script>
    ...
    const detailShowCartUrlTemplate = "<?php echo e(url('cart/details')); ?>";
</script>
...
<?php /**PATH C:\Users\Dalin\Desktop\DalinLaravel\resources\views/site/layouts/sidebar.blade.php ENDPATH**/ ?>