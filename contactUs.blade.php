...
@section('content')
		...
		<div class="top-single-bkg topsinglepage">
			<div class="topsingleimg"> <img src="{{ asset('site/images/2.jpg') }}" alt="" width="1920" height="1080"></div>
					...
					<div class="row">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<h2 class="display-4">"We’re excited to collaborate with you. Let’s create something amazing together!"</h2>
							</div>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
							<div class="row">
								<div class="col-md-6">
									...
									<ul class="footer-contact">
										<li><i class="fas fa-map-marker-alt"></i><span>istanbul,turkey</span></li>

										<li><i class="fas fa-mobile-alt"></i><span>05510069156</span></li>
										<li><i class="far fa-envelope"></i><span>glamourgroup@gmail.com</span></li>
									</ul>
								</div>
								<!-- /col-md-6 -->
								<div class="col-md-6">
